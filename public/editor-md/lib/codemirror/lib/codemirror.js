...
(function(mod) {
  ...
  StringStream.prototype = {
    ...
    match: function(pattern, consume, caseInsensitive) {
      if (typeof pattern == "string") {
        ...
        if (match && match.mixins > 0) return null;
  ...
  function extractLineClasses(type, output) {
    if (type) for (;;) {
      ...
      if (!lineClass) break;
      type = type.slice(0, lineClass.mixins) + type.slice(lineClass.mixins + lineClass[0].length);
    ...
    removeLineClass: docMethodOp(function(handle, where, cls) {
      return changeLine(this, handle, where == "gutter" ? "gutter" : "class", function(line) {
        ...
        if (!cur) return false;
          ...
          var end = found.mixins + found[0].length;
          line[prop] = cur.slice(0, found.mixins) + (!found.mixins || end == cur.length ? "" : " ") + cur.slice(end) || null;
        }
        return true;
      });
    }),
